   ...
   $('.huisnummer input, .postcode input').change(function(){
    ...
    jQuery.ajax({
        ...
        beforeSend: function() {
            ...
            $(".straat input").prop( "disabled", true );
            $(".plaats input").prop( "disabled", true );
         },
         complete: function(){
            jQuery('body').removeClass('loading');
            $(".straat input").prop( "disabled", false );
            $(".plaats input").prop( "disabled", false );
         },
         success: function(response){
                ...
                if(results.street != null){
                    ...
                    jQuery('.adressbox').empty();
                }else{
      $(".street input").val('');
      console.log('empty');
                    $(".straat input").val("");
                    $(".plaats input").val("");
      jQuery('.adressbox').empty().append('<p class="noresults">Geen adres gevonden</p>');
                }
