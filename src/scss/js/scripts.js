...
jQuery(document).ready(function ($) {
    $(".kapital input").bind("keyup change", function(e) {
        var val = $(this).val()
        $(this).val(val.toLowerCase().replace(/\b[a-z]/g, function(letter) {
        ...
        beforeSend: function() {
         ...
         success: function(response){
                ...
                if(results.street != null){
                    ...
                    $(".straat input").val(results.street);
                    $(".plaats input").val(results.city);
                }else{
                    console.log('empty');
                    $(".straat input").val("");
                    $(".plaats input").val("");
